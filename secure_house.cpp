/**********************************************************
*Author: Brock McCullough                                 *
*Date: 18September2017*                                   * 
*Description: This program implements a given security    *
* policy for a secure house. Guests may enter the house if*
* they have a key certified by the owner of the house, or *
* if police/firefighters enter their secret key. Test file*
* (input.txt) and Makefile are both available             *
***********************************************************/
