...
--> This program implements a secuirty policy put in place for a secure house. Once all documents are entered into the same directory, To set up and run the program:
